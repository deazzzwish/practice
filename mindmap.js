	 ...
	 if ( (typeof arguments.callee.instance=='undefined') ) { //если объект ещё не создан
		 arguments.callee.instance = new function() {
		     ...
		     var my_all_data_template = { //задаём первоначальные данные, если это первый запуск
				 "n1":{ id:1, parent_id:0, title:"Mind map" },
    			 "n2":{ id:2, parent_id:1, title:"2", icon:"icon-gift" },
    			 "n3":{ id:3, parent_id:2, title:"3", icon:"icon-flow-line" }, 
    			 "n5":{ id:5, parent_id:3, title:"4", icon: "icon-link" }, 
    			 "n4":{ id:4, parent_id:3, title:"5" }, 
    			 "n7":{ id:7, parent_id:6, title:"6", icon: "icon-link" }, 
    			 "n8":{ id:8, parent_id:1, title:"7", icon: "icon-lamp" }, 
    			 "n9":{ id:9, parent_id:8, title:"8" },
    			 "n10":{ id:10, parent_id:2, title:"9", icon: "icon-floppy-1" },
    			 "n11":{ id:11, parent_id:17, title:"10" },
    			 "n12":{ id:12, parent_id:17, title:"11" },
    			 "n13":{ id:13, parent_id:17, title:"12" },
    			 "n14":{ id:14, parent_id:10, title:"13", icon: "icon-link" },
    			 "n15":{ id:15, parent_id:10, title:"14" },
    			 "n16":{ id:16, parent_id:2, title:"15", icon: "icon-cd" },
    			 "n17":{ id:17, parent_id:10, title:"16" },
    			 "n18":{ id:18, parent_id:6, title:"17" },
    			 "n20":{ id:20, parent_id:8, title:"18" },
    			 "n19":{ id:19, parent_id:8, title:"19" },
    			 "n22":{ id:22, parent_id:16, title:"20" },
    			 "n23":{ id:23, parent_id:16, title:"21" },
    			 "n24":{ id:24, parent_id:2, title:"22", icon: "icon-emo-wink" },
    			 "n6":{ id:6, parent_id:2, title:"23", icon: "icon-list" }, 
    			 "n25":{ id:25, parent_id:24, title:"24", icon: "icon-link" },
    			 "n27":{ id:27, parent_id:2, title:"25", icon: "icon-link" },
    			 "n26":{ id:26, parent_id:24, title:"26" }
    		   };
		 	 ...
		 	 this.jsRenderAllMap = function(focus_id) { //выводим все элементы карты на экран
			 	 ...
			 	 jsMakeDroppable(); //делаем новые элементы перетаскиваемыми
			 	  //делаем перемещение элементов по карте
		 	 }
